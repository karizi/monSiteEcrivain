...
//POUR INSERER LES COMMENTAIRES DANS UNE BASE DE DONNEES
...
if(isset($_POST['commenter'])) {
    ...
    if (count($errors) == 0) {
        ...
        $q = $db->prepare('INSERT INTO comments(idComment, comment, date, idTypeComment) 
        VALUES(DEFAULT, :comment, now(), 2)');
        $q->execute([
            'comment' => $comment
        ]);
